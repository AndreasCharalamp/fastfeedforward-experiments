...
def load_model(pth):
  ...
  model2.magic_w1 = torch.nn.Parameter(checkpoint['magic_w1'])
  model2.magic_w2 = torch.nn.Parameter(checkpoint['magic_w2'])
  model2.magic_b1 = torch.nn.Parameter(checkpoint['magic_b1'])
  model2.magic_b2 = torch.nn.Parameter(checkpoint['magic_b2'])
  model2.k = torch.nn.Parameter(checkpoint['k'])
